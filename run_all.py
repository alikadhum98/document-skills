...
TOOLS = {
    "btr":     {
        "الاسم":   "مولّد تقرير BTR",
        "المسار":  "tools/btr_generator/btr_generator.py",
        "الوصف":   "تقرير الشفافية الثنائي العربي",
    },
    "a6":      {
        "الاسم":   "متابعة المادة السادسة",
        "المسار":  "tools/article6_tracker/a6_tracker.py",
        "الوصف":   "تتبع مفاوضات ITMOs والتعديلات المقابلة",
    },
    "ghg":     {
        "الاسم":   "تحليل الجرد الوطني",
        "المسار":  "tools/ghg_analyzer/ghg_analyzer.py",
        "الوصف":   "رسوم بيانية وإحصاءات الانبعاثات",
    },
    "pptx":    {
        "الاسم":   "مولّد عروض المفاوضات",
        "المسار":  "tools/pptx_generator/pptx_generator.py",
        "الوصف":   "PowerPoint للمؤتمرات والمفاوضات",
    },
    "finance": {
        "الاسم":   "تتبع التمويل المناخي",
        "المسار":  "tools/finance_tracker/finance_tracker.py",
        "الوصف":   "تحليل فجوات GCF ومصادر التمويل",
    },
}
